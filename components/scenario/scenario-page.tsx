import {moduleDocs} from '@/lib/scenario/docs'
import {mockScenario} from '@/lib/scenario/mock'
import {calculateBuyRent, calculateInvestment, calculateLivingCost, calculatePersonal, calculateRetirement} from '@/lib/scenario/calc'
